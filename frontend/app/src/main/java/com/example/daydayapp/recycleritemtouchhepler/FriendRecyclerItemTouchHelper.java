...
public class FriendRecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    private static final String TAG = "Friends";
    private final FriendAdapter adapter;
    private final MainActivity main;
    private final HashMap<String, FriendModel> friendEmailMap;

    public FriendRecyclerItemTouchHelper(FriendAdapter adapter, MainActivity main, HashMap<String, FriendModel> friendEmailMap){
        super(0, ItemTouchHelper.LEFT);
        this.adapter = adapter;
        this.main = main;
        this.friendEmailMap = friendEmailMap;
    }
    ...
    public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction){
        ...
        if(direction == ItemTouchHelper.LEFT){
            ...
            builder.setPositiveButton("Confirm", (dialog, which) -> {
                String email = adapter.getFriend(position).getEmail();
                adapter.deleteItem(position);
                friendEmailMap.remove(email);
